...
const fumbleTables: FumbleTables = {
	'Hand Arms': [
		...
		{ range: [36, 50], effect: 'Dropping your weapon. It will take 1 round to draw a new one or 2 rounds to recover old one.' },
		{ range: [51, 65], effect: 'You lose your wind and realize that you should try to relax. -40 to activity for 2 rounds.' },
		{ range: [66, 79], effect: 'You stumble. The clueless display leaves you stunned for 2 rounds. With luck, you might still survive.' },
		{ range: [80, 80], effect: 'Incredibly inept move. Roll a \'B\' crush crit upon landing. If you are using a slashing weapon, your weapon is broken.' },
		...
		{ range: [97, 99], effect: 'Stumble over an uneven imaginary deceased turtle. You are very confused. Stunned 3 rounds.' },
		{ range: [100, 100], effect: 'Worst move seen in ages. -60 to activity from a pulled groin. Fie or stunned 2 rounds laughing.' },
		{ range: [101, 106], effect: 'You fall in an attempt to commit suicide. Stunned 3 rounds. If using a shield, you fall on top of it.' },
	...
	'Missile Weapons': [
		...
		{ range: [51, 65], effect: 'Drop ammunition. Stunned this round. -40 to next round activity whether to retrieve it.' },
		...
		{ range: [91, 96], effect: 'You let your arrow fly too soon. You are at 20\' short of target. You are at -30 activity for 3 rnds.' },
		{ range: [97, 99], effect: 'You seem to think the your bow is a baton. It slips. Trying to grab it, you knock a 5\' rut front of you.' },
		...
		{ range: [111, 116], effect: 'Trigger slips while you are bringing up your weapon. Make an attack with no modifications to the closest combatant.' },
		{ range: [117, 119], effect: 'While daydreaming you put your hand in front of the quarrel while firing. Lose a finger. +9 hits. 2 hits per round.' },
		{ range: [120, 120], effect: 'You slip and pin your foot to the ground with a quarrel. +10 hits. 2 hits per round. -30 to activity permanently.' }
	],
	'Spell Fumble': [
		{ range: [-49, 5], effect: 'Lose concentration due to strain. Spell lost, but not power points.' },
		{ range: [6, 20], effect: 'Second thoughts. No spell may be cast. Be prepared next round.' },
		{ range: [21, 35], effect: 'Indecision due to mild mental lapse. Spell delayed one round.' },
		{ range: [36, 50], effect: 'Serious mental lapse. Spell lost, but not power points. -30 to activity for 3 rounds.' },
		...
		{ range: [97, 99], effect: 'You seem to think the your bonfire. Reverse roles of target and caster in spell effect. +3 CP.*' },
		...
		{ range: [111, 116], effect: 'Spell strays and travels to a point 20 feet left of target. Anyone in line takes an unmodified attack. Stunned 5 rounds. +6 CP.*' },
		{ range: [117, 119], effect: 'Spell strays and travels to a point 20 feet left of target. Anyone in line takes an unmodified attack. Stunned 5 rounds. +10 CP.*' },
	...
	'Moving Maneuver': [
		...
		{ range: [97, 99], effect: 'Your arm breaks when you land on it. +14 hits. -30 to activity. Stunned 3 rounds.' },
		...
		{ range: [120, 120], effect: 'You fall turns into a dive. You crash your skull and die.' }
	]
};
